...
<?php  
    $nameErr = $emailErr = $passErr = $salaryErr = $departmentErr = "";
    $name = $email = $dob = $gender = $pass = $salary = $department = "";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (!empty($name) && !empty($email) && !empty($pass) && !empty($salary) && !empty($department)) {
            ...
            if (mysqli_num_rows($r) > 0) {
                ...
                $sql = "INSERT INTO employee (name, email, password, dob, gender, salary, department) VALUES ('$name', '$email', '$pass', '$dob', '$gender', '$salary', '$department')";
